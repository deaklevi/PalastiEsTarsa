<!-- resources/views/emails/new-offer-notify.blade.php -->
<!DOCTYPE html>
<html lang="hu">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Új ajánlatkérés érkezett</title>
  <style>
    body {
...
<body>
  <div class="email-container">
    ...
    <div class="email-body">
      <p>Egy új ajánlatkérés érkezett az oldalon. Az alábbiakban találhatók a részletek:</p>
