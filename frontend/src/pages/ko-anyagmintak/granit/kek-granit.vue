...
<route lang="json">
{
  "name": "ko-anyagminta-kek-granit",
  "meta": {
    "title": "Kék gránit – Palásti és Társa Kft.",
    "description": "A kék gránit is magmás eredetű kőzet, mint bármely másik színű. A „gránit” egy gyűjtő név, amit az alkotó ásványok és kristályok előfordulásának változatossága tesz különbözővé, változatossá. Színét általában a földpátok, azaz kőzetalkotó ásványok határozzák meg. Kevesebb kvarcot tartalmazó típusa a granoszienit, a kvarc nélkül, nagyobbrészt földpátokból álló kőzet a szienit."
  }
}
</route>