<template>
    ...
    <div class="flex xl:flex-row flex-col xl:items-center justify-center xl:justify-between mt-5 md:mt-10 max-w-[1500px] mx-auto xl:w-[90%] ">
        <iframe class="mx-auto xl:mx-0 xl:w-[50%] w-[90%]" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d477.3589620649822!2d19.0526161349237!3d47.4051136213671!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4741e7c8d2b9cd75%3A0xebe62123ff0173d0!2zUGFsw6FzdGkgw6lzIFTDoXJzYSBLZnQu!5e0!3m2!1shu!2shu!4v1765231742459!5m2!1shu!2shu" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <div class="xl:mt-0 mt-20 xl:m-0 md:m-28 m-10">
            <img class="h-20 mb-3" src="../../../public/Kapcsolat/emblema.png" alt="Palásti és Társa kft. embléma.img">
            <h1 class="mb-12">Palásti és TársaKőfeldolgozó Kft.</h1>
    ...
    <div class="flex flex-col items-center md:mx-12">
        <h2 class="mt-5 md:mt-10 text-xl font-bold w-full text-center md:text-left">Írjon nekünk</h2>
    </div>
