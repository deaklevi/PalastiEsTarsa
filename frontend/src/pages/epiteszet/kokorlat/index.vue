<template>
  <BaseLayout>
    ...
    <BaseArchitectureCard group="kokorlat" />
    ...
    <!-- Itt már csak a komponens -->
    <BaseArchitectureCard group="kokorlattipusok" />
  </BaseLayout>
</template>

<script>
import BaseLayout from '@layouts/BaseLayout.vue'
import BaseArchitectureCard from '@components/BaseArchitectureCard.vue'
...
<route lang="json">
{
  "name": "epiteszet-kokorlat",
  "meta": {
    "title": "Kőkorlát – Palásti és Társa Kft.",
